...
int TestAES()
{
	...
	int i = 0;
	for (i = 0; i < decrypt_outdata_d_length; i++)
	{
...
int TestFile()
{
	...
	printf("文件加密中.............\n");
	if (file_encrypt(ENCRYPT_AES, "2.jpg", "2.en", buff_password) != 0)
	{
	...
	printf("文件解密中.............\n");
	if (file_decrypt(ENCRYPT_AES, "2.en", "3.jpg", buff_password) != 0)
	{
...
int TestAES2()
{
	...
	int i = 0;
	for (i = 0; i < encrypt_outdata_e_length; i++)
	{
		printf("%02x ", outdata_e[i]);
	}
	printf("\n");
