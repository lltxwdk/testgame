...
#define RIGHT_BRACE ']'
	...
	*/
	int SR_ReadIniString(const char *section, const char *key, char *value,
	...
	*/
	int SR_ReadIniInt(const char *section, const char *key, int default_value,
		const char *file)
	{
		char value[32] = { 0 };
		if (SR_ReadIniString(section, key, value, sizeof(value), NULL, file) != 0)
		{
	...
	* @return 0 : success\n 非0 : failure
	*/
	int SR_WriteIniString(const char *section, const char *key,
