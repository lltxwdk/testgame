...
public:
	...
	virtual void OnClosed(int socket_fd, void* context) = 0;
...
public:
    ...
    virtual void OnClosed(int socket_fd, void* context)
    {
        INetTcpEvent* tcp_event = static_cast<INetTcpEvent*>(context);
        tcp_event->OnClosed(socket_fd, context);
    }
...
public:
    ...
    {
        INetUdpEvent* udp_event = static_cast<INetUdpEvent*>(context);
        udp_event->OnClosed(socket_fd, context);
    }
