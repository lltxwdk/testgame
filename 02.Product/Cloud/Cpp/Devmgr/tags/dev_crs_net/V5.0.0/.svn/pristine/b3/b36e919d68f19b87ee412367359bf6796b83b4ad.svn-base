...
public:
	...
	void Handle_CmdHJGW_OPAVConfig_msg(void *pArg);
...
protected:
	...
	bool ProcessReqRegister(const SRMsgs::ReqRegister* req, DeviceConnect *pClient, CDeviceConfig* pDeviceConfig, CDevice* pDevice, CDataDictionary* pDataDictionary, CSysParameter* pSysParameter, SRMsgs::RspRegister* rspsend);
	...
	void SplitString(string src, vector<unsigned int>& veclist, const std::string& cutFlag);
