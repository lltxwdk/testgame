...
public:
	...
	int GetUseEdgeServer() { return m_useedgeserver; }
	std::string GetChairmanList() { return m_chairman_list; }
	...
	void SetUseEdgeServer(int useedgeserver) { m_useedgeserver = useedgeserver; }
	void SetChairmanList(std::string chairman_list) { m_chairman_list = chairman_list; }
	void SetSecretKey(std::string secret_key) { m_secret_key = secret_key; }
	//
	bool InsertDB();
	bool DeleteDB();
