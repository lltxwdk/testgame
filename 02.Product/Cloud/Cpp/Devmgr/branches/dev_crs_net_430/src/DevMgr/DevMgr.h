...
protected:
	...
	bool ProcessReqRegister(const SRMsgs::ReqRegister* req, DeviceConnect *pClient, CDeviceConfig* pDeviceConfig, CDevice* pDevice, CSysParameter* pSysParameter, SRMsgs::RspRegister* rspsend);
