...
public:
	...
	CMpSysMtu* m_pMainMpSysMtu;
	std::map<CAsyncThread*, CMpSysMtu*> m_mapAsyncThreadMpSysMtu;
...
protected:
	...
	bool ProcessReqRegister(const SRMsgs::ReqRegister* req, DeviceConnect *pClient, CDeviceConfig* pDeviceConfig, CDevice* pDevice, CMpSysMtu* pMpSysMtu, SRMsgs::RspRegister* rspsend);
