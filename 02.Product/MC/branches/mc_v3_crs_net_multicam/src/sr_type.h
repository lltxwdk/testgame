...
#define SR_PRINT_EMERG  TL_EMERG
#define SR_PRINT_ALERT  TL_ALERT
#define SR_PRINT_CRIT   TL_CRIT
#define SR_PRINT_ERROR  TL_ERR
#define SR_PRINT_WARN	TL_WARNING
#define SR_PRINT_NORMAL TL_NOTICE
#define SR_PRINT_INFO   TL_INFO
#define SR_PRINT_DEBUG  TL_DEBUG
